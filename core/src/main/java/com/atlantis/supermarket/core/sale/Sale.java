...
public class Sale extends BaseEntityAuditable {
    ...
    public Sale createSale(Client client, Collection<SaleItem> items, Collection<Payment> paymentMethods) throws PaymentCalculationErrorException, SaleObtainTotalErrorException, NotEnoughMoneyException, NeedExactChangeMoneyException {
